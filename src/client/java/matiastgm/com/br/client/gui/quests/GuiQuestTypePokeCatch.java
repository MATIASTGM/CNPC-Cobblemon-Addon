...
import matiastgm.com.br.quest.QuestPokeCatch;
...
public class GuiQuestTypePokeCatch extends GuiNPCInterface implements ITextfieldListener, ICustomScrollListener
{
    ...
    public void init() {
        ...
        for (PokemonEntry entry : quest.getTargets().keySet()) {
            int idOffset = i*3;
            this.addTextField(new GuiTextFieldNop(idOffset, this,  guiLeft + 4, guiTop + 70 + i * 22, 140, 20, entry.getType()));
            this.addTextField(new GuiTextFieldNop(idOffset + 1, this,  guiLeft + 150, guiTop + 70 + i * 22, 24, 20, quest.getTargets().get(entry) + ""));
